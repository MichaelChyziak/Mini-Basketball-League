...
User.create(username: "user4", email: "user4@example.com", password: "useruser4", password_confirmation: "useruser4")
User.create(username: "user5", email: "user5@example.com", password: "useruser5", password_confirmation: "useruser5")
User.create(username: "user6", email: "user6@example.com", password: "useruser6", password_confirmation: "useruser6")
